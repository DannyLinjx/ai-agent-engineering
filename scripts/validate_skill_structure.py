...
REQUIRED = [
    ...
    "templates/browser-react-fastapi/backend/tests/test_api.py",
    "templates/browser-react-fastapi/backend/requirements-browser-dev.txt",
    ...
    "templates/browser-react-fastapi/web/src/app/RuntimeRoot.tsx",
    "templates/browser-react-fastapi/web/src/app/api/controlPlane.ts",
